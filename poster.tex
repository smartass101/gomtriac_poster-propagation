...
\headerbox{Do \textsc{YOU} want to}{name=motivation,column=0,row=0}{
  \begin{itemize}
...
\headerbox{Acknowledgment}{name=acknowledgment, column=0, below=references}
{
  The course is supported by \textsc{Fusenet} and the Czech Technical university
}
\headerbox{References}{name=references, column=1, below=<>}
{
  \begin{itemize}
