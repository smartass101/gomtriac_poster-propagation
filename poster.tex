...
\headerbox{Course Outline}{name=outline, column=0, below=motivation}{
  \begin{itemize}
  \item  Focused on basic understanding of experimental tokamak physics and control
  \item \textsc{gomtraic} starts March 6 and finishes May 30, 2012
  \item Participants will address 9 tasks regarding basic tokamak physics and technology

  \end{itemize}
}

\headerbox{\textsc{golem} tokamak}{name=golem, column=1, below=motivation}{
The key asset of \textsc{gomtraic} is remote operation of the \textsc{golem} tokamak  which is operated at the Czech  Technical University, Faculty of  Nuclear Sciences and Physical Engineering in Prague
\begin{center}
...
\headerbox{Participants}{name=participants, column=0, below=outline, above=acknowledgment}{
  \begin{itemize}
    \item Undergraduate and postgraduate students interested in experimental tokamak physics
  \item Participation from home possible, no need to leave the country to get experienced in tokamak operation
  \end{itemize}
}
